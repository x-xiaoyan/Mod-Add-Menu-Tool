...
![选择文件](images/pic5.png?t=1765083965196)    
...
中间为菜单区域：点击选中按钮；左键可拖动按钮调整顺序，按钮为选中状态时，右键点击为删除按钮    

右侧为图标列表区域：点击图标可以将中间区域选中的按钮修改为对应图标；   

拖动调整按钮顺序：

![拖动按钮调整顺序](images/pic6.png?t=1765083965196)

点击文本内容输入修改文本：

![输入修改文本](images/pic7.png?t=1765083965196)

操作字体栏可控制文本是否显示，以及修改字体、大小、粗细等。

不显示按钮文本：

![不显示按钮文本](images/pic8.png?t=1765083965196)

修改字体：

![修改字体](images/pic9.png?t=1765083965196)


### 4\. 点击生成菜单，完成时弹出是否打开文件夹的对话框     

![弹出打开文件夹对话框](images/pic10.png?t=1765083965196)  
